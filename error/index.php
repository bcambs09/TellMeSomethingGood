...
<html>
    ...
    <body class="bodySubmitWrap">
        ...
        <div id="header" class="submitWrap">
            <div id="messagePost">
                Something went wrong. Make sure you prove you are a human, check your connection, and try again.<br><br>You will be redirected to the homepage in 5 seconds.
            </div>
        </div>
